...
@section('main')
    <div class="col text-end">
        <a href="{{ route('participants-invitation-brac.index') }}" style="color: white;" type="submit"
    ...
    <div class="pdf-document" id="participant-pdf">
        ...
        <div id="participant-details">
            ...
            <div class="pdf-section">
                <h4>BRAC Employee Information</h4>
                <table class="pdf-table">
                    <tr>
                        <th>BRAC Email</th>
                        <td class="pdf-value">{{ $participant->brac_email }}</td>
                    </tr>
                    <tr>
                        <th>Budget Code</th>
                        <td class="pdf-value">{{ $participant->brac_pin }}</td>
                    </tr>
                </table>
            </div>
