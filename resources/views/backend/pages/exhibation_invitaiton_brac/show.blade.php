...
@section('main')
    <div class="col text-end">
        <a href="{{ route('exhibitions-invitation-brac.index') }}" style="color: white;" type="submit"
        ...
        <div id="field-visit-details">
            ...
            <div class="pdf-section">
                ...
                <table class="pdf-table">
                    <tr>
                        <th>BRAC Email</th>
                        <td class="pdf-value">{{ $exhibition->brac_email }}</td>
                    </tr>
                    <tr>
                        <th>Budget Code</th>
                        <td class="pdf-value">{{ $exhibition->brac_pin }}</td>
                    </tr>
                </table>
            </div>
