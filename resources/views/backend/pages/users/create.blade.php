                    ...
                    <div class="row g-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input name="full_name" type="text" class="form-control @error('full_name') is-invalid @enderror"
                                      id="fullName" placeholder="Full Name" value="{{old('full_name')}}"  /> 
                                    @error('full_name')
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input name="user_name" type="text" class="form-control @error('user_name') is-invalid @enderror"
                                      id="userName" placeholder="User Name" value="{{old('user_name')}}"  /> 
                                    @error('user_name')
                                      <p class="text-danger">{{$message}}</p>
                                    @enderror    
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <select id="roleId" name="role_id" class="select2 form-select @error('role_id') is-invalid @enderror">
