...
@section('main')
    ...
    <h4 class="py-3 mb-4 fs-5 ">
        ...
        <span class="heading-color">All Participants</span>
    </h4>
...
@push('script')
    <script>
        $(document).ready(function() {
            // 👇 Save the DataTable instance to a variable
                        ...
                        action: function () {
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    let url = "{{ route('participants.export') }}" +
                    ...
                    },
                    {
                        ...
                        action: function () {
                            ...
                            if (selected.length === 0) {
                                Swal.fire('No rows selected', 'Please select at least one participant.', 'warning');
                                return;
                            }
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    $.ajax({
                                        url: "{{ route('participants.bulkStatusUpdate') }}",
                                        method: "POST",
                                        data: {
                                            _token: "{{ csrf_token() }}",
                                            ids: selected,
