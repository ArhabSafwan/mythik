    ...
    <div class="row mb-2">
        <div class="col">
            <h4 class="py-3 mb-4 fs-5 d-inline">
                ...
                <span class="heading-color">FAQ Create</span>
            </h4>
        </div>
        <div class="col text-end">
            <a href="{{ route('climate_stories.index') }}" style="color: white;" type="submit"
               class="btn btn-primary me-sm-3 me-1 waves-effect waves-light"><i class="ti ti-arrow-left me-sm-1 ti-xs"></i>All FAQ</a>
        </div>
    </div>
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                    <textarea name="description" data-length="500" class="form-control char-textarea @error('description') is-invalid @enderror"
                                              id="" rows="3"
