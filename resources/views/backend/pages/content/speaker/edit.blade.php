        ...
        <div class="col-xxl">
            <div class="card mb-4">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Speaker Update</h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('speakers.update', $speaker->id) }}"
                        ...
                        <div class="row g-3">
                            <div class="col-md-12 col-lg-12 col-sm-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="full_name" type="text"
                                                ...
                                                id="first-name" placeholder="Full Name"
                                                value="{{ old('full_name', $speaker->full_name) }}" />
                                            @error('full_name')
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="row">
                                        <label class="col-sm-3 col-form-label text-sm-end" for="country">Country</label>
                                        <div class="col-sm-9">
                                            <input name="country" type="text"
                                                class="form-control @error('country') is-invalid @enderror" id="country"
                                                placeholder="Country" value="{{ old('country', $speaker->country) }}" />
                                            @error('country')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="designation" type="text"
                                                ...
                                                value="{{ old('designation', $speaker->designation) }}" />
                                            @error('designation')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="row">
                                        <label class="col-sm-3 col-form-label text-sm-end" for="url">Organization's URL</label>
                                        <div class="col-sm-9">
                                            <input name="url" type="text"
                                                class="form-control @error('url') is-invalid @enderror" id="url"
                                                placeholder="URL" value="{{ old('url', $speaker->url) }}" />
                                            @error('url')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea name="details" id="details" placeholder="Details.."
                                                class="form-control @error('details') is-invalid @enderror" value="">{{ old('details', $speaker->details) }}</textarea>
                                            @error('details')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="row image-div">
                                        <label class="col-sm-3 col-form-label text-sm-end" for="image">Picture (282x321
                                            PX)</label>
                                        <div class="col-sm-9">
                                        ...
                                        <div class="col-sm-8 mt-5" style="height: 180px;width: 220px;">
                                            <img class="img-responsive image-show"
                                                src="{{ $speaker->image ? Storage::disk('public')->url($speaker->image) : asset('images/no-image-uploded.png') }}"
                                                alt="{{ $speaker->name ?? '' }}" style="height:100%;width: 100%;" />
                                        </div>
                                    </div>
                                </div>
                            </div>
