...
@section('main')
    ...
    <h4 class="py-3 mb-4 fs-5">
        <span class="text-muted fw-light">Speakers /</span>
        <span class="heading-color">All Speakers</span>
    </h4>

    <!-- Climate Stories Table -->
    <div class="card">
        <div class="card-header">
            <a href="{{ route('speakers.create') }}" style="color: white;">
                <button class="btn btn-primary waves-effect waves-light" type="button">
                    <i class="ti ti-plus me-0 me-sm-1 ti-xs"></i>
                    <span class="d-none d-sm-inline-block">Create Speakers</span>
                </button>
            </a>
        </div>
