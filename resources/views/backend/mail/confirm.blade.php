...
<body>
    ...
    <div class="container">
        ...
        <p>
            Please find your official invitation card and payment invoice attached. Kindly keep a digital or printed
            copy of the invitation card for travel and event access purposes.
        </p>
        ...
        <p> Should you have any immediate queries or support needs, please feel free to reach out to us at </br>
            <a href="mailto:frugalinnovation@brac.net"
                style="font-weight: medium; font-size: 13px; color: #007160;">frugalinnovation@brac.net</a>or drop a text
