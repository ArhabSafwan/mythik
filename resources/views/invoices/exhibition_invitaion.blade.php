...
<body>
    <div class="content">
        ...
        <div class="justified">
            ...
            <ul>
                <li><span class="highlight">Showcasing your products/services</span> to a diverse audience of
                    practitioners, policymakers, funders,
                    private sector players, donors, and researchers from both Bangladesh and around the world.
                </li>
                <li>Engagement through <span class="highlight">curated sessions</span> and <span
                        class="highlight">impact talks</span>.</li>
                <li>Take part in <span class="highlight">peer learning</span> and <span class="highlight">networking
                        opportunities</span> with like minded innovators aimed at
                    building valuable connections and practical insights.</li>
            </ul>
