    ...
    <div class="content">
        ...
        <div class="justified">
            ...
            <p>On behalf of BRAC and the Frugal Innovation Forum Team, it is our pleasure to formally invite you to join
                us
                for a convening of thought leaders, innovators, and practitioners committed to co-creating solutions for
                a
                more equitable and sustainable future.</p>


            <p>
                <span class="highlight">Event Details:</span><br>
                <strong>Date:</strong> 25th and 26th July, 2025<br>
                <strong>Venue:</strong> BCDM, Savar, Bangladesh<br>
            ...
            <ul>
                <li>Access to dynamic <span class="highlight">panel discussions</span>, impact talks, and interactive
                    <span class="highlight">breakout sessions</span> with climate
                    leaders, entrepreneurs, climate scientists, innovators, and development practitioners.
                </li>
                <li>Take part in <span class="highlight">peer learning</span> and <span class="highlight">networking
                        opportunities</span> aimed at building
                    valuable connections and practical insights.</li>
                <li>Explore an <span class="highlight">exhibition space</span> showcasing innovative, climate-adaptive
                    initiatives led by practitioners.</li>
            </ul>
