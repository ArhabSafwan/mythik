                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <img src="{{ asset('storage/' . $item->product->image) }}" alt="{{ $item->product->title }}" style="width: 50px; height: 50px; object-fit: cover;" class="me-3">
                                            <a href="{{ route('product.show', ['slug' => $item->product->slug]) }}">{{ $item->product->title }}</a>
                                            @endif
                                        </div>
                                    </td>
