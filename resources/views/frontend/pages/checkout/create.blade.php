...
@section('fif_content')
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="termsModalLabel">Terms & Conditions – Conference
                            Participants</h5>
                    </div>
    ...
    <section class="register-event">
        <div class="container">
            <form id="checkout-form" action="{{ route('checkout.initiate') }}" method="POST">
                @csrf
                <div class="row g-4">
                        ...
                        <div class="checkout-card">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input type="text" class="form-control" id="full_name" name="full_name"
                                        value="{{ $participantinvitation->full_name }}" readonly />
                                </div>
                                <div class="col-md-6 mb-2">
                                    <label class="checkout-label" for="email">Email Address</label>
                                    <input type="email" class="form-control" id="email" name="email"
                                        value="{{ $participantinvitation->email }}" readonly />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input type="text" class="form-control" id="nationality" name="nationality"
                                        value="{{ $participantinvitation->nationalityName->name }}" readonly />
                                </div>
                                <div class="col-md-6 mb-2">
                                    <label class="checkout-label" for="passport_nid">Passport/NID Number</label>
                                    <input type="text" class="form-control" id="passport_nid" name="passport_nid"
                                        value="{{ $participantinvitation->proof_number }}" readonly />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input type="text" class="form-control" id="country_code" name="country_code"
                                        value="{{ $participantinvitation->country_code }}" readonly />
                                </div>
                                <div class="col-md-6 mb-2">
                                    <label class="checkout-label" for="contact_number">Contact Number (WhatsApp)</label>
                                    <input type="text" class="form-control" id="contact_number" name="contact_number"
                                        value="{{ $participantinvitation->contact_number }}" readonly />
                                </div>
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input type="text" class="form-control" id="emergency_country_code"
                                        ...
                                        value="{{ $participantinvitation->emergency_country_code }}" readonly />
                                </div>
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input type="text" class="form-control" id="emergency_contact_number"
                                        ...
                                        value="{{ $participantinvitation->emergency_contact_number }}" readonly />
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ $participantinvitation->dietary_restrictions_others }}" disabled />
                            </div>
                            <div class="mb-3">
                                <label class="checkout-label">Prayer/Meditation Space Required</label>
                                <input type="text" class="form-control"
                                    value="{{ $participantinvitation->meditation_space }}" disabled />
                            </div>
                            <div class="mb-3">
                                <label class="checkout-label">Medical Conditions/Allergies</label>
                                <input type="text" class="form-control"
                                    value="{{ $participantinvitation->medical_condition }}" disabled />
                            </div>
                            <div class="mb-3">
                                <label class="checkout-label">Medical Conditions/Allergies Other</label>
                                <input type="text" class="form-control"
                                    value="{{ $participantinvitation->medical_condition_details }}" disabled />
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"
                                    value="{{ $participantinvitation->accomodation }}, I confirm" disabled />
                            </div>
                            <div class="mb-3">
                                <label class="checkout-label">Event Photography/Recording Consent</label>
                                <input type="text" class="form-control"
                                    value="{{ $participantinvitation->photographed_recorded }}" disabled />
                            </div>
                        </div>
                    </div>
                    <!-- Right: Order Summary -->
                    <div class="col-lg-5">
                        <div class="order-summary">
                            ...
                            <div class="mb-3">
                                ...
                                <div><strong>{{ $participantinvitation->category_type }}</strong></div>


                            </div>
                            <input type="hidden" value="{{ $participantinvitation->category_type }}"
                                name="category_type" />
                            <input type="hidden" value="{{ $participantinvitation->cost }}" name="amount" />
                            <input type="hidden" value="{{ $participantinvitation->currency }}" name="currency" />
                            <input type="hidden" value="{{ $participantinvitation->id }}"
                                name="participant_invitation_id" />
                            <input type="hidden" value="{{ $participantinvitation->uuid }}"
                                name="participant_invitation_uuid" />
                            ...
                            <div class="d-flex justify-content-between mb-2">
                                <span>Total</span>
                                <span class="fw-bold">{{ $participantinvitation->currency }}
                                    {{ $participantinvitation->cost }}</span>
                            </div>
                            @if ($participantinvitation->currency !== 'BDT')
                                <div class="d-flex justify-content-between mb-2">
                                    <span>
...
@push('fscript')
    ...
    <script>
        $(document).ready(function() {
            const AGREED_KEY = 'fif_terms_agreed_' + "{{ $participantinvitation->uuid }}";
            ...
            if (localStorage.getItem(AGREED_KEY) !== 'true') {
                ...
                $('#pay-now').prop('disabled', false); // enable payment if already agreed
            }
