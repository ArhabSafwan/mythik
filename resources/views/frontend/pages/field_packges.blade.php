...
@section('ftitle', 'Field Visit Participant')
@section('meta_tag')
    <meta name="title"
...
@section('fif_content')
    ...
    <style>
        ...
        @media (max-width: 1399.98px) {
            ...
            .pricing-box .mt-4.pt-2 p.text-white {
                font-size: 0.85rem;
            }
        }
        ...
        <div class="container">
            <div class="row w-100 justify-content-start content">
                <div class="col-lg-12 mb-4 mb-lg-0">
                    <h2 class="highlight">Frugal Innovation Forum 2025 - Field Visitor Application Form</h2>
                    <p class="description">Theme: Climate adaptation in agriculture, food security and livelihood</p>

                    <div>
                        <span class="step-description">At the conference page, interested participants will be able to see
                            the event details -</span>
                        <p class="text-white">Over the past few years, FIF has created a platform to facilitate critical
                            ...
                            dynamic panel discussions, interactive breakout sessions, impact talks, and a dedicated space
                            for practitioners to showcase innovative, climate-adaptive initiatives.<br>
                            This year FIF will take place on <strong>25th and 26th July</strong> in Bangladesh,
                            preceded by a field visit to a climate-vulnerable area on <strong>23rd and 24th July.</strong>
                        </p>
                    </div>
                    ...
                    <div>
                        <p class="text-white">
                            ...
                            <strong>Conference Dates:</strong> <strong>25th and 26th July</strong>, 2025
                        </p>
                    </div>
                    ...
                    <div>
                        <p class="text-white">Both field visits will take place on <strong>23rd and 24th July, 2025</strong>
                            . You can participate in either -</p>
                    </div>
                    <div>
                        <p class="text-white">
                            <strong>Dhaka–Rajshahi–Dhaka:</strong> This curated visit offers participants an immersive
                            understanding of climate vulnerability and community resilience in northern
                            Bangladesh,<strong>OR</strong>
                        </p>
                    </div>

                    {{-- <div>
                        <p class="text-white">
                            <strong>Dhaka–Mongla–Dhaka:</strong> This visit offers an in-depth look at climate vulnerability
                            and adaptive practices in one of Bangladesh’s most exposed coastal zones.
                        </p>
                    </div> --}}

                    <div>
                        <p class="text-white">
                            Join us at FIF, to help facilitate collaborations for meaningful, scalable impact of
                            climate-resilient solutions in agriculture, food security and livelihoods across the Global
                            South.
                        </p>
                    </div>
                    ...
                    <div class="row pt-4 justify-content-center">
                        <div class="col-lg-4">
                            <div class="pricing-box mt-4 text-white"
                                ...
                                <div class="" style="text-align: center;">
                                    <p class="f-20 highlight" style="color: #D5E03A">Field Visit: North</p>
                                    <h4 class="f-20 highlight" style="color: #D5E03A">Dhaka-Rajshahi-Dhaka</h4>
                                    <p class="text-white">23rd and 24th July</p>

                                    <div class="pricing-plan mt-4 pt-2">
                                        <h4 class="text-muted"><span class="plan pl-3 text-white">USD 275*</span>
                                        </h4>
                                ...
                                <div class="mt-4 pt-2">
                                    ...
                                    <p class="mb-2 text-white"><i class="mdi mdi-checkbox-marked-circle f-18 mr-2"
                                        ...
                                        Travel by air & BCDM drop-off</p>
                                    <p class="mb-2 text-white"><i class="mdi mdi-checkbox-marked-circle f-18 mr-2"
                                            style="color: #D5E03A"></i>
                                        Local transportation in visit area</p>
                                    <p class="mb-2 text-white"><i class="mdi mdi-checkbox-marked-circle f-18 mr-2"
                                            style="color: #D5E03A"></i>
                                        1N stay (3-star hotel) on 23rd July</p>
                                    <p class="mb-2 text-white"><i class="mdi mdi-checkbox-marked-circle f-18 mr-2"
                                            style="color: #D5E03A"></i>
                                        All meals and snacks during visit
                                    </p>
                                    <p class="mb-2 text-white"><i class="mdi mdi-checkbox-marked-circle f-18 mr-2"
                                            style="color: #D5E03A"></i>
                                        Guided experience with a volunteer
                                    </p>
                                </div>
                                ...
                                <div class="mt-4 pt-3" style="text-align: center;">
                                    <a href="field/visits/create?package=Field Visit: DHK-RJH-DKH&price=275&currency=USD"
                                ...
                                <p class="text-white mt-3 text-end" style="font-size: smaller; color: #D5E03A !important;">
                        ...
                        {{-- <div class="col-lg-4">
                            <div class="pricing-box mt-4 text-white"
                                style="background: linear-gradient(90deg, #004238, #01251f); border: 2px solid #D5E03A;">
                                <div class="" style="text-align: center;">
                                    <p class="f-20 highlight" style="color: #D5E03A">Field Visit: South</p>
                                    <h4 class="f-20 highlight" style="color: #D5E03A">Dhaka-Mongla-Dhaka</h4>
                                    <p class="text-white">23rd and 24th July</p>

                                    <div class="pricing-plan mt-4 pt-2">
                                        <h4 class="text-muted"><span class="plan pl-3 text-white">USD 200*</span>
                                        </h4>
                                        <p class="text-white mb-0">Per Participant</p>
                                    </div>
                                </div>
                                ...
                                <div class="mt-4 pt-2">
                                    ...
                                    <p class="mb-2 text-white"><i class="mdi mdi-checkbox-marked-circle f-18 mr-2"
                                            style="color: #D5E03A"></i>
                                        Travel by microbus & BCDM drop-off</p>
                                    <p class="mb-2 text-white"><i class="mdi mdi-checkbox-marked-circle f-18 mr-2"
                                            style="color: #D5E03A"></i>
                                        Local transportation in visit area</p>
                                    <p class="mb-2 text-white"><i class="mdi mdi-checkbox-marked-circle f-18 mr-2"
                                ...
                                <div class="mt-4 pt-3" style="text-align: center;">
                                    <a href="field/visits/create?package=Field Visit: Dhaka-Mongla-Dhaka&price=200&currency=USD"
                                        class="btn btn-primary btn-rounded apply2-now-btn"
                                        style=" border-radius: 8px; border: 3px solid #D5E03A; padding: 5px 40px 5px 40px; background: linear-gradient(90deg, #004238, #01251f);">Apply
                                        Now</a>
                                </div>
                        ...
                        <div class="col-lg-4">
                            <div class="pricing-box mt-4 text-white"
                                ...
                                <div class="" style="text-align: center;">
                                    ...
                                    <div class="pricing-plan mt-4 pt-2">
                                        <h4 class="text-muted"><span class="plan pl-3 text-white">BDT 13,000</span>
                                        </h4>
                                        <p class="text-white mb-0">Per Participant</p>
                                    </div>
                                </div>
                                ...
                                <div class="mt-4 pt-3" style="text-align: center;">
                                    <a href="field/visits/create?package=Field Visit: Dhaka-Mongla-Dhaka&price=13000&currency=BDT"
                                        class="btn btn-primary btn-rounded apply2-now-btn"
                                        style=" border-radius: 8px; border: 3px solid #D5E03A; padding: 5px 40px 5px 40px; background: linear-gradient(90deg, #004238, #01251f);">Apply
                                        Now</a>
                                </div>
