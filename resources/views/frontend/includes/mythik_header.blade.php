    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-dark">
            <div class="container-fluid">
                ...
                <a class="navbar-brand d-lg-none mx-auto" href="{{ url('/') }}"><img src="{{ asset('frontend/images/icon/icon.png') }}" alt="Mythik"
                        class="logo"></a>
                ...
                <div class="collapse navbar-collapse" id="main-nav">
                    <div class="d-none d-lg-flex justify-content-between w-100 align-items-center">
                        ...
                        <!-- Center Logo -->
                        <a class="navbar-brand" href="{{ url('/') }}"><img src="{{ asset('frontend/images/icon/icon.png') }}" alt="Mythik"
                                class="logo"></a>
