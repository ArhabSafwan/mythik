...
(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    const flatpickrRange = document.querySelector('#flatpickr-range'); // Change the selector to match your actual element

    if (flatpickrRange !== null && typeof flatpickrRange !== 'undefined') {
      flatpickr(flatpickrRange, {
        mode: 'range',
        dateFormat: 'd/m/Y'
      });
    } else {
      console.error('Flatpickr range element not found');
    }
  });
